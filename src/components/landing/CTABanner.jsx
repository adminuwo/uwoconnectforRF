  ...
  return (
    <section className="max-w-5xl mx-auto px-6 pb-24 md:pb-32">
      <div className="glass-card rounded-[32px] p-10 md:p-16 text-center border border-white/10 relative overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
        {/* Glow Effects */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent via-[#10B981] to-transparent" />
        <div className="absolute -top-32 -left-32 w-64 h-64 bg-[#10B981]/20 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-[#059669]/20 rounded-full blur-[100px] pointer-events-none" />

        <div className="w-16 h-16 mx-auto bg-gradient-to-br from-[#10B981] to-[#059669] rounded-2xl flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(16,185,129,0.3)]">
