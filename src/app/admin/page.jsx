           ...
           <div className="lg:col-span-2 bg-white rounded-[40px] border border-slate-100 premium-shadow p-10">
              ...
              <div className="space-y-3">
                 {loading ? (
                    ...
                    <div key={auto._id || auto.id} className="p-5 bg-slate-50/50 border border-slate-100 rounded-[24px] flex items-center justify-between group hover:bg-white hover:border-[#059669]/20 hover:premium-shadow transition-all cursor-pointer">
                      <div className="flex items-center gap-4">
                         <div className={cn("w-11 h-11 rounded-xl flex items-center justify-center border transition-all shadow-sm", auto.enabled ? "bg-white text-[#059669] border-[#059669]/10" : "bg-slate-100 text-slate-300 border-transparent")}>
            ...
            <div className="bg-gradient-to-br from-[#f0fdf4] to-white rounded-[40px] p-10 text-slate-800 border border-emerald-100 premium-shadow flex flex-col group overflow-hidden relative">
