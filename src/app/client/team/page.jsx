...
import { 
  ...
  Building2, Trash2, Mail, Shield, CheckCircle2, Clock, AlertTriangle, ChevronRight
} from 'lucide-react';
...
export default function TeamPage() {
  const [activeTab, setActiveTab] = useState('DIRECTORY'); // DIRECTORY, TASKS, CHAT, REPORTS, APPROVALS, ANALYTICS, COPILOT
