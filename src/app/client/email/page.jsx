...
const ClientEmailPage = () => {
  ...
  // Sample Inbox Data (each message has a 'provider' field: 'gmail' or 'outlook')
  const sampleMessages = [
    // ── OUTLOOK MESSAGES ──
    {
      ...
      preview: 'Hi Abha, We have updated the multi-channel broadcast module requirements. Please check attached documents for review.',
      body: 'Hi Abha,\n\nWe have updated the multi-channel broadcast module requirements. Please check attached documents for review.\n\nLet me know your feedback so we can proceed with staging deployment.\n\nBest regards,\nAditi Sharma',
      time: '10:45 AM',
      date: 'Today',
      is_read: false,
      has_attachment: true,
      attachment_name: 'requirements_v2.pdf',
      has_meeting: true,
      meeting_info: { title: 'Product Demo Call', provider: 'Microsoft Teams', time: '10:00 AM', link: 'https://teams.microsoft.com' }
    },
    {
      id: '2',
      folder: 'inbox',
      ...
      preview: 'Hello Abha, Your support ticket #8492 has been received and assigned to our engineering team.',
      body: 'Hello Abha,\n\nYour support ticket #8492 has been received and assigned to our engineering team. We will resolve your gateway configuration within 24 hours.',
      time: 'Yesterday',
      date: 'Aug 6',
      is_read: true,
    ...
    },
    {
      ...
      sender_email: 'rahul@acme.com',
      to: 'Abha@uwo24.com',
      subject: 'Enterprise Plan Quotation Request',
      preview: 'Dear UWOConnect Team, Acme Corp wants to onboard 50 team members to your Enterprise Marketing suite.',
      body: 'Dear UWOConnect Team,\n\nAcme Corp wants to onboard 50 team members to your Enterprise Marketing suite. Kindly send us your official pricing brochure.',
      time: 'Aug 5',
      date: 'Aug 5',
      is_read: true,
      has_attachment: false
    },
    {
      ...
      to: 'priya@techcorp.in',
      subject: 'Scheduled Product Presentation Deck',
      preview: 'Hello Priya, Here is your scheduled presentation deck for tomorrow morning.',
      body: 'Hello Priya,\n\nHere is your scheduled presentation deck for tomorrow morning.',
      time: 'Tomorrow 9:00 AM',
      date: 'Aug 8',
      is_read: true,
      has_attachment: true,
      attachment_name: 'presentation_deck.pdf'
    },
    {
      id: '5',
      folder: 'drafts',
      ...
      subject: '[Draft] Quarterly Sales Partnership Strategy',
      preview: 'Hi Team, Here is the preliminary draft for our Q3 marketing alliance...',
      body: 'Hi Team,\n\nHere is the preliminary draft for our Q3 marketing alliance.',
      time: 'Draft Saved',
      date: 'Today',
      is_read: true,
      has_attachment: false
    ...
    // ── GMAIL MESSAGES ──
    {
      ...
      to: 'abha@gmail.com',
      subject: 'Your Google Workspace billing summary for August',
      preview: 'Hi Abha, Your monthly Google Workspace billing summary is ready for review.',
      body: 'Hi Abha,\n\nYour monthly Google Workspace billing summary is ready for review.\n\nTotal: ₹12,500 for 10 users.\n\nThank you,\nGoogle Workspace Team',
      time: '9:30 AM',
      date: 'Today',
      is_read: false,
      has_attachment: true,
      attachment_name: 'billing_aug_2026.pdf'
    },
    {
      id: '7',
      folder: 'inbox',
      ...
      sender_email: 'priya.mehta@startup.io',
      to: 'abha@gmail.com',
      subject: 'Partnership Proposal: UWOConnect x StartupIO',
      preview: 'Hi Abha, We would love to explore a co-marketing partnership between our platforms.',
      body: 'Hi Abha,\n\nWe would love to explore a co-marketing partnership between StartupIO and UWOConnect.\n\nLet me know a good time for a quick call.\n\nBest,\nPriya Mehta',
      time: 'Yesterday',
      date: 'Aug 6',
      is_read: true,
      has_attachment: false
    },
    {
      ...
      provider: 'gmail',
      sender_name: 'Abha Jatav',
      sender_email: 'abha@gmail.com',
      to: 'dev-team@uwo24.com',
      subject: 'Re: Sprint Review Notes & Action Items',
      preview: 'Team, Please find the updated sprint review notes attached.',
      body: 'Team,\n\nPlease find the updated sprint review notes attached.\n\nLet us sync tomorrow at 10 AM.\n\nAbha',
      time: 'Aug 5',
      date: 'Aug 5',
      is_read: true,
      has_attachment: true,
      attachment_name: 'sprint_review_notes.pdf'
    },
    {
      id: '9',
      folder: 'drafts',
      ...
      sender_name: 'Abha Jatav',
      sender_email: 'abha@gmail.com',
      to: 'investors@venture.com',
      subject: '[Draft] Q3 Investor Update - UWOConnect',
      preview: 'Dear Investors, Here is our Q3 progress report with key metrics...',
      body: 'Dear Investors,\n\nHere is our Q3 progress report with key metrics and growth highlights.',
      time: 'Draft Saved',
      date: 'Today',
      is_read: true,
      has_attachment: false
