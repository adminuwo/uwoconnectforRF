...
import { Loader2, Clock, Sparkles, Eye, EyeOff, ShieldCheck } from 'lucide-react';
      ...
      <div className="w-full max-w-[400px] z-10 bg-white/80 backdrop-blur-[24px] border border-white/50 rounded-[36px] p-5 sm:py-5 sm:px-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] flex flex-col items-center">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            ...
            title="Sign up with Unified Web Options (UWO)"
            className="h-10 px-3.5 bg-gradient-to-r from-[#21432a] to-[#3a6843] hover:from-[#1a3822] hover:to-[#2e5536] text-white rounded-full flex items-center justify-center gap-1.5 shadow-lg shadow-emerald-950/15 hover:scale-105 transition-all cursor-pointer border border-emerald-400/30"
          >
            <ShieldCheck className="w-4 h-4 text-emerald-300" />
            <span className="text-xs font-bold uppercase tracking-wider">UWO SSO</span>
          </button>

          <button onClick={handleGoogleLogin} title="Continue with Google" className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg shadow-emerald-950/5 hover:scale-105 transition-all cursor-pointer">
          ...
          <button onClick={handleFacebookLogin} title="Continue with Facebook" className="w-10 h-10 bg-[#1877F2] rounded-full flex items-center justify-center shadow-lg shadow-emerald-950/5 hover:scale-105 transition-all cursor-pointer">
            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
            </svg>
          </button>
          <button onClick={handleGithubLogin} title="Continue with GitHub" className="w-10 h-10 bg-slate-900 rounded-full flex items-center justify-center shadow-lg shadow-emerald-950/5 hover:scale-105 transition-all cursor-pointer">
            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
